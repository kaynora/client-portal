...
const Chat = () => {
  ...
  const getAllChats = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/chat/get-all-chats`, {
        method: 'GET',
        credentials: 'include'
      })
  ...
  const getChat = async (id: number) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/chat/get-chat-history?client_id=${id}`, {
        method: 'GET',
        credentials: 'include'
      })
  ...
  const submitMessage = async (e: React.SubmitEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/chat/send-message?client_id=${paramClientID}`, {
        method: 'POST',
