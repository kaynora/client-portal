...
const ProjectPage = () => {
    ...
    const getProject = async (paramProjectID: string) => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/get-project?project_id=${paramProjectID}`, {
                method: 'GET',
                credentials: 'include'
            })
    ...
    const assignClient = async (event: React.MouseEvent) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/assign-client?project_id=${paramsProjectID}`, {
                method: 'PUT',
                credentials: 'include',
                headers: {
    ...
    const setStatus = async (status: string) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/set-project-status?project_id=${paramsProjectID}`, {
                method: 'PUT',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json'
