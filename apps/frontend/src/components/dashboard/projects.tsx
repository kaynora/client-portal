...
const Projects = () => {
    ...
    const getProjects = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/get-project-headers?status=active&client_id=${paramClientID}`, {
                method: 'GET',
                credentials: 'include'
            })
    ...
    const updateProjectOrder = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/sort-active-projects`, {
                method: 'POST',
                credentials: 'include',
                headers: {
