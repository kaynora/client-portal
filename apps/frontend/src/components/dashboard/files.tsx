...
const Files = () => {
    ...
    const getFileHeaders = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/get-file-headers?project_id=${paramProjectID}`, {
                method: 'GET',
                credentials: 'include'
            })
    ...
    const uploadFile = async (file: File) => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/upload-file?project_id=${paramProjectID}`, {
                method: 'PUT',
                body: formData,
                credentials: 'include'
            })
    ...
    const deleteFile = async (id: string) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/delete-file?project_id=${paramProjectID}&file_id=${id}`, {
                method: 'DELETE',
                credentials: 'include'
            })
    ...
    const downloadFile = async (id: string, filename: string) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_HOST}/api/admin/project/get-file?project_id=${paramProjectID}&file_id=${id}`, {
                method: 'GET',
                credentials: 'include'
            })
